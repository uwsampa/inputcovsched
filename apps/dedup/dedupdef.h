...
// XXX Sizes reduced for klee
#ifdef ENABLE_KLEE

#define QUEUE_SIZE 256

#define NUM_BUF_CHECKCACHE 256
#define NUM_BUF_DECOMPRESS 256
#define NUM_BUF_REASSEMBLE 256

#define MAXBUF (5*1024)
#define ANCHOR_JUMP (512)

#define MAX_PER_FETCH 100

#define ITEM_PER_FETCH 5
#define ITEM_PER_INSERT 5

#define CHUNK_ANCHOR_PER_FETCH 5
#define CHUNK_ANCHOR_PER_INSERT 5
