...
#define __PARSEC_XSTRING(x) __PARSEC_STRING(x)
  ...
  compress = TRUE;  // XXX: TRUE or FALSE
  conf->preloading = 0;
  conf->method = METHOD_FILE;
  conf->nthreads = 1;  // XXX: fork for 1,2,4,8
  // TODO: make these symbolic?
  //conf->b_size
  //conf->preloading
  // TODO: make these symbolic strings? does it matter?
  // conf->infine
  // conf->outfile
...
#endif
#ifdef ENABLE_KLEE
  // Making this smaller for klee
  cache = create_hashtable(256, hash_from_key_fn, keys_equal_fn);
#else
