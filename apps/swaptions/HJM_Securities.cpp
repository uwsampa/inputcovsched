...
#define __PARSEC_XSTRING(x) __PARSEC_STRING(x)
        ...
        nThreads = 2;  // FIXME: must be a constant for now, but we should fork for each of {2,4,8}
        KLEE_READ_VARIABLE_INPUT(NUM_TRIALS);
        KLEE_READ_VARIABLE_INPUT(nSwaptions);
