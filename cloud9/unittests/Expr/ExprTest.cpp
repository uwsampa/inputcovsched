...
ref<Expr> getZero() {
  return ConstantExpr::create(0, Expr::Int32);
}
...
TEST(ExprTest, ConcatExtract) {
  const Array *array = Array::createSymbolic("arr0");
  ref<Expr> read8 = Expr::createArrayReadAtIndex(array, getZero(), 8, true);
  const Array *array2 = Array::createSymbolic("arr1");
  ref<Expr> read8_2 = Expr::createArrayReadAtIndex(array2, getZero(), 8, true);
...
TEST(ExprTest, ExtractConcat) {
  const Array *array = Array::createSymbolic("arr2");
  ref<Expr> read64 = Expr::createArrayReadAtIndex(array, getZero(), 64, true);

  const Array *array2 = Array::createSymbolic("arr3");
  ref<Expr> read8_2 = Expr::createArrayReadAtIndex(array2, getZero(), 8, true);
